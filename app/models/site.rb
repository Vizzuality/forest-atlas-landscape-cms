...
class Site < ApplicationRecord
  ...
  cattr_accessor :form_steps do
    { pages: %w[name managers publishers contexts style style_settings site_settings finish],
      names: ['Name', 'Managers', 'Publishers', 'Contexts', 'Style', 'Style Settings', 'Site Settings', 'Finish'] }
  end
