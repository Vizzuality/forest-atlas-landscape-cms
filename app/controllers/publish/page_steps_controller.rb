class Publish::PageStepsController < PublishController
  include Wicked::Wizard
  include TreeStructureHelper

  before_action :authenticate_user_for_site!, only: [:new, :show, :update, :filtered_results, :widget_data]

  # The order of prepend is the opposite of its declaration
  prepend_before_action :load_wizard
  prepend_before_action :set_steps
  prepend_before_action :build_current_page_state, only: [:show, :update, :filtered_results, :widget_data]
  prepend_before_action :set_site, only: [:new, :show, :update, :filtered_results, :widget_data]
