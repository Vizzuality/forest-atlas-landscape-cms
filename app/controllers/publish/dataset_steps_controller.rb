class Publish::DatasetStepsController < PublishController
  include Wicked::Wizard
  include NavigationHelper

  before_action :set_site, only: [:new, :show, :update]
  before_action :steps_names
  before_action :build_current_dataset_state, only: [:new, :show, :update]
